export const devlogs = [
  {
    slug: "v0-0-5-cimientos-del-prototipo",
    publicVersion: "v0.0.5",
    title: "Cimientos del prototipo",
    realFolder: "v1",
    stage: "Cimientos",
    summary:
  ...
  {
    slug: "v0-1-0-guardado-y-primeros-sprites",
    publicVersion: "v0.1.0",
    title: "Guardado y primeros sprites",
    realFolder: "v3.6",
    stage: "Cimientos",
    summary:
  ...
  {
    slug: "v0-1-5-bucle-de-captura-conectado",
    publicVersion: "v0.1.5",
    title: "Bucle de captura conectado",
    realFolder: "v9",
    stage: "Bucle principal",
    summary:
      "Captura, equipo, caja y Pokedex empiezan a trabajar juntos. Se añade el modo master",
    highlights: [
      "Se añade el modo master para simular combates",
      "Se añade la función de captura e incorporación a equipo",
      "Se rediseña el resumen post-batalla como prototipo",
      "El diseño de la escena de combate se edita a un formato claro",
  ...
  {
    slug: "v0-2-0-pokedex-y-tienda-mejoradas",
    publicVersion: "v0.2.0",
    title: "Pokedex y tienda mejoradas",
    realFolder: "v24.3",
    stage: "Sistemas",
    summary:
  ...
  {
    slug: "v0-2-5-pase-de-identidad-visual",
    ...
    longDescription:
      "Esta etapa comienza a trabajar de verdad la identidad visual del combate. El proyecto deja de parecer un conjunto de sistemas funcionales para acercarse a una experiencia mas reconocible, con mejor presencia y una personalidad mas marcada.",
    media: []
  },
  {
  ...
  },
  {
    ...
    stage: "Pulido",
    summary:
      "La comodidad del jugador mejora con mejor lectura de estados, repaso del equipo y menus secundarios mas expresivos.",
    highlights: [
      "Estados alterados mas claros con iconos y color",
      "Repaso del equipo tras los combates",
  ...
  {
    slug: "v0-5-0-nuevo-comienzo-de-aventura",
    publicVersion: "v0.5.0",
    title: "Nuevo comienzo de aventura",
    realFolder: "v88",
    stage: "Aventura",
    summary:
    ...
    longDescription:
      "Pokemon Ascenso empieza aqui a sentirse menos como un prototipo centrado en sistemas y mas como una aventura con tono propio. El arranque de la partida gana identidad, contexto y una presentacion mucho mas cercana a la idea de viaje Pokemon.",
    media: []
  },
  {
    slug: "v0-5-5-build-de-rutas-y-aventura",
    publicVersion: "v0.5.5",
    title: "Build de rutas y aventura",
    realFolder: "v91.9",
    stage: "Aventura",
    summary:
      "Se rediseña por completo el flujo del juego, se elimina el sistema de fases y se convierte en un recorrido por rutas, pueblo, ciudad, pruebas y una prueba final.",
    highlights: [
      "Aparecen rutas, ciudad, pueblo y pruebas especiales",
      "Se suman entrenadores con identidad propia",
